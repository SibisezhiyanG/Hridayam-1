...
These Terms & Conditions govern your use of our website [insert URL] and services. By
...
Hridayam is not responsible for delays caused by courier services or natural disruptions.</p>
        ...
        <p className='font-[lato] text-[#41444B] w-3/4'>We offer returns/exchanges subject to our [Return Policy – insert link if available]
...
You agree not to post anything offensive, illegal, or infringing on others’ rights.</p>
        ...
        <p className='font-[lato] text-[#41444B] w-3/4'>Your use of the site is also governed by our [Privacy Policy – insert link]. Please review it to
...
Delays, errors, or losses outside our control.</p>
        ...
        <p className='font-[lato] text-[#41444B] w-3/4'>These terms are governed by the laws of [Insert Country/State], and any disputes will be
        handled in the courts of [Insert Jurisdiction].</p>
