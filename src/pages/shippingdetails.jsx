...
<h1 className='font-[cinzel] font-[500] text-3xl text-black'>Shipping Changes :</h1>
        <p className='font-[lato] text-[#41444B] w-3/4'>Free shipping on orders above ₹[insert amount] (within India)
...
To request a return/exchange, email us at [insert email] with your order number and reason.</p>
